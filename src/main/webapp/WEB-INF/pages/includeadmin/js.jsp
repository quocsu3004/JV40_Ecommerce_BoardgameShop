...
<script src="<c:url value="/resources-management/plugins/popper/popper.min.js"/>" ></script>
<script src="<c:url value="/resources-management/plugins/jquery-blockui/jquery.blockui.min.js"/>" ></script>
<script src="<c:url value="/resources-management/plugins/jquery-slimscroll/jquery.slimscroll.min.js"/>"></script>
<!-- bootstrap -->
...
<!-- morris chart -->
<script src="<c:url value="/resources-management/plugins/morris/morris.min.js"/>" ></script>
<script src="<c:url value="/resources-management/plugins/morris/raphael-min.js"/>" ></script>
<script src="<c:url value="/resources-management/js/pages/chart/morris/morris_home_data.js"/>" ></script>
<!-- data tables -->
